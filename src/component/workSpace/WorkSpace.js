        ...
        <div className='sm:py-[12.5rem] py-20  relative'>
            <div className='lg:px-40 px-6 '>
                ...
                <div className='md:mt-[12.5rem] mt-20'>
                    ...
                    <div className='mt-5'>
                        <div className='lg:flex-row flex flex-col justify-center items-center xl:gap-x-28 gap-x-20 '>
                        ...
                        <div className='lg:flex-row flex flex-col justify-center items-center xl:gap-x-20 sm:gap-10 gap-x-10 '>
