...
function CustomerCard(props) {
    return (
        // <div className={`${} py-14 px-7 bg-white h-[300px] mt-[${customer.mt}] rounded-[1.2rem] leading-[4.5rem] max-w-[270px] font-semibold text-[3.5rem]`}
        ...
        <div className='py-14 px-7 bg-white h-[300px] mb-10 text-[#111029] rounded-[1.2rem] leading-[4.5rem] max-w-[270px] font-semibold text-[3.5rem]'>
            ...
            >{props.title}</h1>
            <p className=' text-lg font-normal mt-5 text-center leading-8'>{props.desc}</p>
        </div>
    )
}
