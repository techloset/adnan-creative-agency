...
function Customer() {
    return (
        <div className='bg-[#F9F9FD] py-[6.4rem]'>
            <div className='flex gap-20 xl:flex-nowrap flex-wrap justify-center lg:px-40 xl:px-0 md:px-10 px-6  mx-0 xl-mx-auto xl-max-w-[1120px] max-w-full'>
                <div className='flex gap-x-10 sm:flex-nowrap flex-wrap  max-w-[580px] justify-center  '>
                ...
                <div className='xl:max-w-[460px] max-w-full whitespace-wrap'>
